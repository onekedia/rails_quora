class QuestionTopicsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @question_topic.save
        ...
        format.json { render :show, status: :created, location: @question_topic }
      else
  ...
  def update
    respond_to do |format|
      if @question_topic.update(question_topic_params)
        ...
        format.json { render :show, status: :ok, location: @question_topic }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to question_topics_url, notice: 'Question topic was successfully destroyed.' }
